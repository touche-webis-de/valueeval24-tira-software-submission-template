# Jupyter Notebook Submissions of TIRA_USER_FOR_AUTOMATIC_REPLACEMENT
...
```
docker push registry.webis.de/code-research/tira/tira-user-TIRA_USER_FOR_AUTOMATIC_REPLACEMENT/submission:0.0.1
```
